...
favoriteThings.car = '1968 Camaro';
...
/*Above you're given a user object. Loop through the user object checking to
make sure
...
//^THIS IS CORRECT BUT STUPID JASMINE WON'T ACCEPT IT//

//Once you get your truthy Object, Change the remaining values in the object to
//be specific to you (name: 'your name', username: 'your username'), rather than
// my information.

  //Code Here

user1.name = 'Daniel';
user1.email = 'danielalegria1217@gmail.com';
user1.pwHash = 'password';
user1.birthday = '12/17/1989';
user1.username = 'danielalegria';
user1.age = 27;
...
//following name -> 'Tyler S. McGinnis', email -> 'tyler.mcginnis@devmounta.in'.
//Make that change.
...
//Now call the sayEmail method that's on the user object which will alert the
//users email
...
methodCollection object. One called 'alertHello' which alerts 'hello' and
...
// parameters and returns a new object with all of the information that you
//passed in.
